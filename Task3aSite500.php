...
$runningtotaly3 = 0;
$runningtotaly4 = 0;
$certaintime = '10:01:00';
$results = array();

// Get data
if (($site215 = fopen("data_500.csv", "r")) !== FALSE) 
{
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Time', 'NO Level'],
          [ 2017,      parseInt('<?php echo $runningtotaly0; ?>')],
          [ 2018,      parseInt('<?php echo $runningtotaly1; ?>')],
          [ 2019,      parseInt('<?php echo $runningtotaly2; ?>')],
          [ 2020,      parseInt('<?php echo $runningtotaly3; ?>')]
        ]);

        var options = {
          title: 'Carbon Monoxide levels over time, Site 500',
