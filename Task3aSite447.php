...
// Get data
if (($site215 = fopen("data_447.csv", "r")) !== FALSE) 
{
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Time', 'NO Level'],
          [ 2006,      parseInt('<?php echo $runningtotaly0; ?>')],
          [ 2007,      parseInt('<?php echo $runningtotaly1; ?>')],
          [ 2008,      parseInt('<?php echo $runningtotaly2; ?>')],
          [ 2009,      parseInt('<?php echo $runningtotaly3; ?>')],
          [ 2010,      parseInt('<?php echo $runningtotaly4; ?>')]
        ]);

        var options = {
          title: 'Carbon Monoxide levels over time, Site 447',
          hAxis: {title: 'Years', minValue: 2006, maxValue: 2010},
