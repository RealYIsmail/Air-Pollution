...
// Get data
if (($site209 = fopen("data_213.csv", "r")) !== FALSE) 
{
...
$runningtotaly0 = $runningtotaly0/$i;
  ...
  $runningtotaly3 = $runningtotaly3/$a;
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Time', 'NO Level'],
          [ 2007,      parseInt('<?php echo $runningtotaly0; ?>')],
          [ 2008,      parseInt('<?php echo $runningtotaly1; ?>')],
          [ 2009,      parseInt('<?php echo $runningtotaly2; ?>')],
          [ 2010,      parseInt('<?php echo $runningtotaly3; ?>')],
          [ 2011,      parseInt('<?php echo $runningtotaly4; ?>')]

        ]);

        var options = {
          title: 'Carbon Monoxide levels over time, Site 213',
          hAxis: {title: 'Years', minValue: 2007, maxValue: 2011},
          vAxis: {title: 'Carbon Monoxide Levels', minValue: 0, maxValue: 100},
          legend: 'none'
        };
