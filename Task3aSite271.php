...
// Get data
if (($site215 = fopen("data_271.csv", "r")) !== FALSE) 
{
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Time', 'NO Level'],
          [ 2004,      parseInt('<?php echo $runningtotaly0; ?>')],
          [ 2005,      parseInt('<?php echo $runningtotaly1; ?>')],
          [ 2006,      parseInt('<?php echo $runningtotaly2; ?>')],
          [ 2007,      parseInt('<?php echo $runningtotaly3; ?>')],
          [ 2008,      parseInt('<?php echo $runningtotaly4; ?>')]
        ]);

        var options = {
          title: 'Carbon Monoxide levels over time, Site 271',
          hAxis: {title: 'Years', minValue: 2004, maxValue: 2008},
